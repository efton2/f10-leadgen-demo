...
// premade stock voice "Rachel" (calm, neutral, classic female). Override with
// the RECEPTIONIST_VOICE_ID env var if you want a different library voice —
// but never point this at a cloned/personal voice.
const DEFAULT_RECEPTIONIST_VOICE_ID = "21m00Tcm4TlvDq8ikWAM"; // "Rachel" (stock)
  ...
  const createRes = await fetch("https://api.elevenlabs.io/v1/convai/agents/create", {
    ...
    body: JSON.stringify({
      ...
      conversation_config: {
        ...
        tts: {
          // ElevenLabs premade stock voice "Rachel" — calm, neutral, classic.
